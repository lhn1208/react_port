...
import {Section, SecTittle } from './common.style';
import { TabListStyle, Progress} from './portfolio.style';
...
export default function Portfolio(){
    ...
    const handleTabClick = (e, tab) => {
       ...
       // 클릭한 탭으로 활성 탭 변경
        ...
        const clickedTab = e.target; // 클릭한 버튼을 선택합니다.
         clickedTab.parentElement.classList.add('on');
    };
